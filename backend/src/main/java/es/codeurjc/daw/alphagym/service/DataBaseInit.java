...
public class DataBaseInit {
    ...
    public void init() throws IOException, SQLException {
        ...
        trainingCommentService.createTrainingComment(entidad2, armsPlan, user);
        ...
        trainingCommentService.createTrainingComment(entidad5, legsPlan, user);
        ...
        trainingCommentService.createTrainingComment(entidad10, backPlan, user);
        ...
        trainingCommentService.createTrainingComment(entidad14, chestPlan, user);
        ...
        trainingCommentService.createTrainingComment(entidad19, chestPlan, user);
        ...
        trainingCommentService.createTrainingComment(entidad22, chestPlan, user);
        trainingCommentService.createTrainingComment(entidad23, chestPlan,null);
        trainingCommentService.createTrainingComment(entidad24, chestPlan, user);
        trainingCommentService.createTrainingComment(entidad25, chestPlan, user);
        trainingCommentService.createTrainingComment(entidad26, chestPlan,null);
        trainingCommentService.createTrainingComment(entidad27, chestPlan, user);
        ...
        trainingCommentService.createTrainingComment(entidad30, chestPlan, user);
        ...
        nutritionCommentService.createNutritionComment(frutas,caloricDeficit, user);
        ...
        nutritionCommentService.createNutritionComment(comentario4,caloricDeficit, user);
        ...
        nutritionCommentService.createNutritionComment(comentario10,maintenanceDiet, user);
        ...
        nutritionCommentService.createNutritionComment(comentario13,maintenanceDiet, user);
        ...
        nutritionCommentService.createNutritionComment(comentario16,caloricDeficit, user);
        nutritionCommentService.createNutritionComment(comentario17,caloricDeficit, user);
        ...
        nutritionCommentService.createNutritionComment(comentario20,caloricDeficit, user);
        nutritionCommentService.createNutritionComment(comentario21,caloricDeficit, user);
        ...
        nutritionCommentService.createNutritionComment(comentario26,caloricDeficit, user);
        nutritionCommentService.createNutritionComment(comentario27,caloricDeficit, user);
